...
const { Game, Category, Mechanic, Thematic, Editorial, Language } = sequelize.models;
...
Game.belongsToMany(Language, { through: 'GameLanguage' });
Language.belongsToMany(Game, { through: 'GameLanguage' });
